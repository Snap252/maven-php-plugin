...
/**
 * Phpunit support for > 4.0.0.
 * 
 * @author Martin Eisengardt <Martin.Eisengardt@googlemail.com>
 * @since 2.0.0
 */
@Component(role = IPhpunitSupport.class, instantiationStrategy = "per-lookup", hint = "PHP_EXE_VENDOR")
public class PhpunitSupportVENDOR extends AbstractPhpunitExeSupport {
    ...
    protected String getExtraArguments() {
        File phpunitXml = phpUnitXml;
		if (phpunitXml != null) {
            return "--configuration \"" + phpunitXml + "\"";
        } else {
            return "";
        }
    }
